...
trktrn_dysthymia_bm = "E:/sound/splice/Samples/packs/Common Drift Loop Kit by Noria/Traktrain_-_Common_Drift_Loop_Kit_by_Noria/Loops/Kit_Loops/Dysthymia/TRKTRN_CDLKBN_105_Distorted_Electric_Guitar_Rhythm_Dysthymia_Bmin_bpm89.wav"
trktrn_dysthymia_clean_bm = "E:/sound/splice/Samples/packs/Common Drift Loop Kit by Noria/Traktrain_-_Common_Drift_Loop_Kit_by_Noria/Loops/Kit_Loops/Dysthymia/TRKTRN_CDLKBN_105_Electric_Guitar_Rhythm_Dysthymia_Clean_Dry_Bmin_bpm89.wav"
...
#  ###############################################################
amp_trktrn_dysthymia_clean_bm = 1
amp_trktrn_dysthymia_clean_bm = 0
live_loop :trktrn_dysthymia_clean_bm do
  sample trktrn_dysthymia_clean_bm ,amp: amp_trktrn_dysthymia_clean_bm, finish: 0.125
  sleep 32
end
