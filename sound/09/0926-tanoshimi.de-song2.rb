...
#fx
dt2_snare = "E:/sound/splice/Samples/packs/White Label - Dub Techno 2/SKU#WL189_-_White_Label_-_Dub_Techno_2_-_Splice/fx_shots/dt2_fx_one_shot_snare.wav"
ta_mk_vox = "E:/sound/splice/Samples/packs/Mark Knight - Trademark Series/Toolroom_Trademark_Series_-_Mark_Knight/VOX/TA_MK_VOX_MALE1_124bpm_Abm.wav"
...
mdt_synth_cm = "E:/sound/splice/Samples/packs/Minimal Deep Tech/SKU#SM-2005-R_-_Minimal_Deep_Tech_-_WAV/one-shots/synth_one-shot/MDT_synth_synthwave_Cmin.wav"
pl_mpoot_stab = "E:/sound/splice/Samples/packs/MIKE Push Origins of Trance/MIKE_Push_Origins_of_Trance_-_ACID_WAV/Synth_One-Shots/PL_MPOOT_Stab_29.wav"
...
live_loop :ff_at_hope_gm do
  ...
  sample pl_mpoot_stab, amp: amp_pl_mpoot_stab
  #  sample mdt_synth_cm, amp: amp_pl_mpoot_stab
  sleep 32
end
...
samp_ta_mk_vox = 0.5
samp_ta_mk_vox = 0
live_loop :ta_mk_vox do
  sample ta_mk_vox ,amp: samp_ta_mk_vox
  sleep 32
end
